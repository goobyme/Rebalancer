import requests, bs4, os, re, openpyxl, shutil, datetime, time, pprint
...
def quote_scraper(ticker):
    ...
    base_url = 'https://finance.google.com/finance?q=' + ticker  # TODO instert try statement for error handling?
